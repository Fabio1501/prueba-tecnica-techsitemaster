...
const PopUpDelete = ({ hiddenListOfClients, setHiddenListOfClients, client }) => {
      ...
      <div className='h-1/2 relative w-1/3 bg-slate-200 text-black rounded-lg p-10'>
        ...
        <div className="h-full flex flex-col gap-y-12 items-center justify-center">
          ...
          <div className="flex items-center gap-x-4">
            ...
            <button onClick={() => setHiddenListOfClients(!hiddenListOfClients)} className="rounded-lg px-4 py-2 font-semibold bg-black text-white">Cancelar</button>
          </div>
        </div>
      </div>
    </div>
